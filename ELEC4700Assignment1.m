%%
% Joud Alhuwaitat, 101074617

%% Part 1: Electron Modelling
% To calculate the thermal energy, we use Maxwell's principle of equipartition
% of energy,
%
...
%
% Below are some variables to control the simulations:
...
%%
% The arrays below will be used to hold  the information  about the
...
% First, we must calculate the scattering probability in one time step:
...
% Here, the boundaries can be set to be either specular or diffusive. If they
% are diffusive, the electrons will bounce off at a random angle rather than
% one that is symmetrical about the normal with the boundary.
%
...
% Each box can seperately be set to be specular (1) or diffusive (0)
...
% is very similar as can be seen. However, some the of the electrons have considerably
